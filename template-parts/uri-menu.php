		...
		<ul id="links">
			...
			<li class="parentcat"><a href="#">Academics</a>
				<ul>
					...
					<li><a href="http://web.uri.edu/prov/">Providence Campus Continuing Ed and Certification</a></li>
			...
			<li class="parentcat"><a href="#">Campus Life</a>
				<ul>
					...
					<li><a href="http://web.uri.edu/career/">Career Services</a></li>
					<li><a href="http://web.uri.edu/healthservices/">Health Services</a></li>
					<li><a href="http://web.uri.edu/enrollment">Enrollment Services</a></li>
			...
			<li class="parentcat"><a href="#">Research &amp; Outreach</a>
				<ul>
					...
					<li><a href="http://web.uri.edu/career/">Experiential Learning</a></li>
			...
			<li class="parentcat"><a href="#">Global</a>
				<ul>
					...
					<li><a href="http://web.uri.edu/globaluri/admission/">International Admission</a></li>
					<li><a href="http://web.uri.edu/globaluri/service/">Service and Internships Abroad</a></li>
					<li><a href="http://web.uri.edu/globaluri/curriculum/">Global Curriculum</a></li>
					<li><a href="http://web.uri.edu/globaluri/research/">Research and Scholarship Abroad</a></li>
					<li><a href="http://web.uri.edu/globaluri/partnerships/">International Partnerships</a></li>
					<li><a href="http://web.uri.edu/globaluri/alumni/">International Alumni</a></li>
				</ul>
			</li>
		</ul>
		<div id="nav-toggle"><span>Menu</span></div>
	</nav>
