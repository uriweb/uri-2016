...
<header id="uri-header" class="uri-branding">
	...
	<div class="site">
		<hgroup>
			<h1><a href="http://uri.edu" title="The University of Rhode Island" class="svg"><object type="image/svg+xml" data="<?php print get_template_directory_uri(); ?>/img/uri-logo-125.svg" id="uri-logo">The University of Rhode Island</object></a></h1>
	...
	<header id="masthead" class="site-header" role="banner"<?php if ( get_header_image() ) { echo ' style="background-image:url(' . get_header_image() . '); height: ' . esc_attr( get_custom_header()->height ) . 'px;"'; } ?>>
		...
		<div class="site nav-wrapper">
			<nav id="site-navigation" class="main-navigation" role="navigation">
				<button class="menu-toggle" aria-controls="primary-menu" aria-expanded="false"><?php bloginfo( 'name' ); ?> Menu</button>
